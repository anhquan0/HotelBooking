                        ...
                        <form class="book_now" action="room-list">
                           <div class="row">
                              <div class="col-md-12">
                                 ...
                                 <input class="online_book" id="check_in_date" placeholder="dd/mm/yyyy" type="date" name="check_in_date">
                              </div>
                              <div class="col-md-12">
         ...
         <div class="container-fluid">
            <div class="row">
               <div class="col-md-5">
                  <div class="titlepage">
                     <h2>About Us</h2>
                     <p>We pride ourselves on being the ideal destination for those seeking a perfect retreat. With a team of professional and dedicated staff, we are committed to delivering a service that is second to none. From the moment you step into the hotel to the moment you depart, your every need will be catered to with the utmost care and professionalism. </p>
            ...
            <div class="row">
               <div class="col-md-4 col-sm-6">
                  <div id="serv_hover"  class="room">
                     ...
                     <div class="bed_room">
                        <h3> Deluxe </h3>
                        <p> Experience luxury and tranquility in this elegantly appointed space, complete with all the amenities. </p>
                     </div>
                  </div>
               </div>
               <div class="col-md-4 col-sm-6">
               ...
               <div class="col-md-4 col-sm-6">
                  <div id="serv_hover"  class="room">
                     ...
                     <div class="bed_room">
                        <h3> Ocean View </h3>
                        <p> Immerse yourself in the endless blue of the ocean from your private balcony, creating unforgettable memories. </p>
                     </div>
                  </div>
               </div>
               <div class="col-md-4 col-sm-6">
               ...
               <div class="col-md-4 col-sm-6">
                  <div id="serv_hover"  class="room">
                     ...
                     <div class="bed_room">
                        <h3> Suite </h3>
                        <p> Indulge in luxurious living space with unique design and top-notch amenities, while taking in the beauty of the city from high above. </p>
                     </div>
                  </div>
               </div>
               <div class="col-md-4 col-sm-6">
                  <div id="serv_hover"  class="room">
                     ...
                     <div class="bed_room">
                        <h3> Standard </h3>
                        <p> A warm and comfortable place to relax after a long day of exploring, providing a home-like feel. </p>
                     </div>
                  </div>
               </div>
            </div>
